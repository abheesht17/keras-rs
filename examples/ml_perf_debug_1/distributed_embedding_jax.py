# -*- coding: utf-8 -*-
"""distributed_embedding_jax

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/keras_rs/ipynb/distributed_embedding_jax.ipynb
...
def train_dataset_generator():
    for inputs, labels in iter(train_ratings):
        for k, v in inputs.items():
            inputs[k] = v.numpy()
        x = model.embedding_layer.preprocess(inputs, training=True)
